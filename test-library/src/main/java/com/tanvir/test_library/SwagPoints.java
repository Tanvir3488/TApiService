...
public class SwagPoints extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        final int min = java.lang.Math.min(width, height);
...
//					updateOnTouch(event);
    ...
    private double convertTouchEventPointToAngle(float xPos, float yPos) {
        ...
        x = (mClockwise) ? x : -x;
        double angle = java.lang.Math.toDegrees(java.lang.Math.atan2(y, x) + (java.lang.Math.PI / 2));
...
//		System.out.printf("(%f, %f) %f\n", x, y, angle);
    ...
    private int convertAngleToProgress(double angle) {
        return (int) java.lang.Math.round(valuePerDegree() * angle);
    }
    ...
    private void updateIndicatorIconPosition() {
        ...
        mIndicatorIconX = (int) (mArcRadius * java.lang.Math.cos(java.lang.Math.toRadians(thumbAngle)));
        mIndicatorIconY = (int) (mArcRadius * java.lang.Math.sin(Math.toRadians(thumbAngle)));
    }
