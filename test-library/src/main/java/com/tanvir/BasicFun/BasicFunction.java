...
public class BasicFunction {
    ...
    public void getResponceData(String URL, String request_json,int Request_Code){
    ...
    public void getResponceData(String URL,int Request_Code){
    ...
    class AsyncTaskc extends AsyncTask<String, String, String> {
        ...
        //  ProgressDialog pDialog;
        String Responce;
        public AsyncTaskc(String json, String URL,int RC) throws JSONException {
        ...
        public AsyncTaskc(String URL,int RC) throws JSONException {
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                Responce =  makeServiceCall(url,json);
                Log.e("Service_Call_Details","Url= "+url+" request_json = " +json+" responce = "+Responce);
    ...
    public static String makeServiceCall(String url1, String MyJson) {
